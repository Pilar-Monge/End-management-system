...
export class ExpeditionController {
  ...
  @ApiCreatedResponse({ description: 'Expedition created' })
  ...
  @ApiOkResponse({ description: 'Expedition found' })
  ...
  @ApiOkResponse({ description: 'Expedition list' })
  ...
  @ApiOkResponse({ description: 'Expedition updated' })
  ...
  @ApiParam({ name: 'id', type: Number, description: 'Expedition id' })
  @ApiOkResponse({ description: 'Expedition deleted' })
  @ApiBadRequestResponse({ description: 'Invalid id' })
  @ApiNotFoundResponse({ description: 'Expedition not found' })
