...
import { ExpeditionResourceConsumedController } from '../../modules/expeditionResourceConsumed/expeditionResourceConsumed.controller';

describe('ExpeditionResourceConsumedController (API controller unit tests)', () => {
  let service: any;
  let controller: ExpeditionResourceConsumedController;
  ...
  beforeEach(() => {
    ...
    controller = new ExpeditionResourceConsumedController(service);
  });
